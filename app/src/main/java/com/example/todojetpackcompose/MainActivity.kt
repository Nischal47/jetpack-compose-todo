...
import com.example.todojetpackcompose.components.navigations.Destinations
import com.example.todojetpackcompose.components.navigations.NavigationComponent
import com.example.todojetpackcompose.database.TodoItem
import com.example.todojetpackcompose.database.TodoViewModel
import com.example.todojetpackcompose.database.TodoViewModelFactory
...
fun HomeView(navController: NavController) {
    ...
    Column(
        ...
        CustomCardState(navController = navController, mTodoViewModel = mTodoViewModel)
